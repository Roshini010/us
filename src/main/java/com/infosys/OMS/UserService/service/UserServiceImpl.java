...
public class UserServiceImpl implements UserService {
	...
	public String addToCart(String prodId, String buyerId, Integer quantity)throws UserMSException {
		...
		Optional<Buyer> opBuyer= buyerRepository.findById(buyerId);
		Buyer b= opBuyer.orElseThrow(()-> new UserMSException("UserService.NO_BUYER"));

		Optional<Cart> optional= cartRepository.findByBuyerIdAndProductId(buyerId, prodId);
	...
	public void removeFromCart(String buyerId,String productId) throws UserMSException{
		Optional<Buyer> opBuyer= buyerRepository.findById(buyerId);
		Buyer b =opBuyer.orElseThrow(()-> new UserMSException("UserService.NO_BUYER"));
        Optional<Cart> optionalCart= cartRepository.findByBuyerIdAndProductId(buyerId, productId);
	...
	public String updateRewardPoint(String buyerId, Integer rewPoints) throws UserMSException {
		...
		b.setRewardPoints(rewPoints.toString());
		
		buyerRepository.save(b);
		
		return "Reward Points Updated for buyer Id : "+ b.getBuyerId();
	}
