...
public class UserServiceAPI {
	...
	{
		ProductDTO productDTO = new RestTemplate().getForObject(prodUri+"/prodMS/getById/"+ wishlistDto.getProdId(), ProductDTO.class);
		if(productDTO==null) {
	...
	{
		ProductDTO productDTO = new RestTemplate().getForObject(prodUri+"/prodMS/getById/"+ prodId, ProductDTO.class);
		if(productDTO==null) {
			String msg="No product Found";
			return new ResponseEntity<>(msg,HttpStatus.OK);
		}
